...
$idBike = 6; // Definição fixa do ID Bikes
        ...
        <div id="carouselExampleDark" class="carousel carousel-dark slide img-fluid" data-bs-ride="carousel">
            <div class="carousel-inner">
                <div class="carousel-item active" data-bs-interval="10000">
                    <img src="https://bhbikes.b-cdn.net/cache/general/fe3c5c/lt805_rcr_n1.jpg" class="d-block w-100 rounded-1" alt="...">
                </div>
                <div class="carousel-item" data-bs-interval="2000">
                    <img src="https://bhbikes.b-cdn.net/cache/general/4a8613/lt805_ssn_n1.jpg" class="d-block w-100 rounded-1" alt="...">
                </div>
                <div class="carousel-item">
                    <img src="https://bhbikes.b-cdn.net/cache/general/524349/lt805_wss_n1.jpg" class="d-block w-100 rounded-1" alt="...">
                </div>
            </div>
            ...
            <div class="accordion-item">
                ...
                <div id="collapseOne" class="accordion-collapse collapse show" data-bs-parent="#accordionExample">
                    <div class="accordion-body overflow-auto">
                        ...
                        <p>The Aerolight Disc is the perfect triathlon bike for elite triathletes. It is designed to cut through the wind, reach high speeds, excel on flat terrain, and make a difference on climbs. A bike that maximizes aerodynamics and lightness without compromising frame stiffness.</p>
                    </div>
                </div>
