  ...
  <div class="offcanvas-body">
        ...
        <div class="container">
            ...
            <div class="timeline">
                <div class="timeline-item left">
                    <h5>2010</h5>
                    <p>Motion Bikes was founded with the mission to provide top-quality cycling gear to enthusiasts worldwide.</p>
                </div>
                <div class="timeline-item right">
                    <h5>2015</h5>
                    <p>We launched our first line of custom bikes, blending performance and aesthetics.</p>
                </div>
                <div class="timeline-item left">
                    <h5>2020</h5>
                    <p>Partnered with leading brands to bring exclusive cycling equipment to our customers.</p>
                </div>
            </div>
        </div>
    </section>
    ...
    <section class="py-5 bg-light">
        <div class="container">
            ...
            <div class="row text-center">
                <div class="col-md-4">
                    <div class="icon">🚴</div>
                    <h5>Passion for Cycling</h5>
                    <p>Our team lives and breathes cycling. Every product is handpicked by experts.</p>
                </div>
                <div class="col-md-4">
                    <div class="icon">🌱</div>
                    <h5>Sustainability</h5>
                    <p>Committed to eco-friendly practices and sustainable product lines.</p>
                </div>
                <div class="col-md-4">
                    <div class="icon">⭐</div>
                    <h5>Customer First</h5>
                    <p>Your satisfaction drives us to constantly innovate and improve.</p>
                </div>
            </div>
        </div>
    </section>
    ...
    <section class="py-5 text-center">
        <div class="container">
            ...
            <a href="Brand.php" class="btn btn-danger">Shop Now</a>
        </div>
    </section>
