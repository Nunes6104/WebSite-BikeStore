        ...
        <div id="carouselExampleDark" class="carousel carousel-dark slide img-fluid" data-bs-ride="carousel">
            <div class="carousel-inner">
                <div class="carousel-item active" data-bs-interval="10000">
                    <img src="https://bhbikes.b-cdn.net/cache/general/cc7b99/la705_nss_n1.jpg" class="d-block w-100 rounded-1" alt="...">
                </div>
                <div class="carousel-item" data-bs-interval="2000">
                    <img src="https://bhbikes.b-cdn.net/cache/general/b359ba/la705_bbb_n1.jpg" class="d-block w-100 rounded-1" alt="...">
                </div>
                <div class="carousel-item">
                    <img src="https://bhbikes.b-cdn.net/cache/general/8bec04/la705_rcr_n1.jpg" class="d-block w-100 rounded-1" alt="...">
                </div>
            </div>
        ...
        <div class="accordion-item">
            ...
            <div id="collapseOne" class="accordion-collapse collapse show" data-bs-parent="#accordionExample">
                <div class="accordion-body overflow-auto">
                    ...
                    <p>The battle against the wind and the battle against gravity, all on the same bike, the Aerolight. Road lines flying beneath its wheels. The sound of the wind at high speed. The desire to drop a gear. The quest for the best possible position.</p>
                </div>
            </div>
        </div>
