...
$idBike = 4; // Definição fixa do ID Bikes
        ...
        <div id="carouselExampleDark" class="carousel carousel-dark slide img-fluid" data-bs-ride="carousel">
            <div class="carousel-inner">
                <div class="carousel-item active" data-bs-interval="10000">
                    <img src="https://bhbikes.b-cdn.net/cache/general/6103ac/da953_ccc_n1.jpg" class="d-block w-100 rounded-1" alt="...">
                </div>
                <div class="carousel-item" data-bs-interval="2000">
                    <img src="https://bhbikes.b-cdn.net/cache/general/2658cc/da953_ggg_n1.jpg" class="d-block w-100 rounded-1" alt="...">
                </div>
                <div class="carousel-item">
                    <img src="https://bhbikes.b-cdn.net/cache/general/f4d7f1/da953_rrr_n1.jpg" class="d-block w-100 rounded-1" alt="...">
                </div>
            </div>
            ...
            <div class="accordion-item">
                ...
                <div id="collapseOne" class="accordion-collapse collapse show" data-bs-parent="#accordionExample">
                    <div class="accordion-body overflow-auto">
                        ...
                        <p>Climb, descend, cover long distances, trail paths, jump, ride on tracks. Whatever you want. On all terrains.</p>
                    </div>
                </div>
