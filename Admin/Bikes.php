...
<div class="container mt-5">
        ...
        <tbody>
            ...
            if ($bikes) {
                foreach ($bikes as $bike) {
                    echo "<tr>";
                    echo "<td>" . htmlspecialchars($bike['idBike']) . "</td>";
                    echo "<td>" . htmlspecialchars($bike['name']) . "</td>";
                    echo "<td>" . htmlspecialchars($bike['typeB']) . "</td>";
                    echo "<td>" . htmlspecialchars($bike['brand']) . "</td>";
                    echo "<td>" . htmlspecialchars($bike['model']) . "</td>";
                    echo "<td>" . htmlspecialchars($bike['price']) . "</td>";
                    echo "<td>" . htmlspecialchars($bike['dta_upload']) . "</td>";
                    echo "</tr>";
                }
            } else {
    ...
    <a class="btn btn-success m-2">Add Bike</a>
