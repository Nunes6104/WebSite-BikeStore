...
try {
    ...
    $stmt = $conn->prepare("SELECT v.idVenda,
                                          l.user_Name,
                                          b.name AS nameBike,
                                          v.dta_Venda,
                                          v.totalPrice
                                   FROM Vendas v
                                   JOIN Login l on v.idUser = l.idUser
                                   JOIN Bikes b on v.idBike = b.idBike
        ...
        <tbody>
            ...
            if ($vendas) {
                foreach ($vendas as $venda) {
                        echo "<tr>";
                        echo "<td>" . htmlspecialchars($venda['idVenda']) . "</td>";
                        echo "<td>" . htmlspecialchars($venda['user_Name']) . "</td>";
                        echo "<td>" . htmlspecialchars($venda['nameBike']) . "</td>";
                        echo "<td>" . htmlspecialchars($venda['dta_Venda']) . "</td>";
                        echo "<td>" . htmlspecialchars($venda['totalPrice']) . "€</td>";
                        echo "</tr>";
                }
            } else {
