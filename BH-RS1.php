...
$idBike = 3; // Definição fixa do ID Bikes
        ...
        <div id="carouselExampleDark" class="carousel carousel-dark slide img-fluid" data-bs-ride="carousel">
            <div class="carousel-inner">
                <div class="carousel-item active" data-bs-interval="10000">
                    <img src="https://bhbikes.b-cdn.net/cache/general/57d523/la405_sns_n1.jpg" class="d-block w-100 rounded-1" alt="...">
                </div>
                <div class="carousel-item" data-bs-interval="2000">
                    <img src="https://bhbikes.b-cdn.net/cache/general/80f3dc/la405_rcr_n1.jpg" class="d-block w-100 rounded-1" alt="...">
                </div>
                <div class="carousel-item">
                    <img src="https://bhbikes.b-cdn.net/cache/general/3f7dbc/la405_cco_n1.jpg" class="d-block w-100 rounded-1" alt="...">
                </div>
            </div>
            ...
            <div class="accordion-item">
                ...
                <div id="collapseOne" class="accordion-collapse collapse show" data-bs-parent="#accordionExample">
                    <div class="accordion-body overflow-auto">
                        ...
                        <p>More aerodynamic, more integration. A fight against the wind in every pedal stroke. A battle that no longer hinders but allows us to enjoy. Only we, cyclists, know the feeling of performance, power, and efficiency we achieve when our body and equipment are working at 100%. The addiction to speed.</p>
                    </div>
                </div>
            </div>
            ...
            <div class="accordion-item">
                ...
                <div id="collapseTwo" class="accordion-collapse collapse" data-bs-parent="#accordionExample">
                    <div class="accordion-body overflow-auto">
                        ...
                        <p>RS1 Disc ACR Monocoque</p>
                        <hr>
                        <p><strong>Fork</strong></p>
                        <p>RS1 Disc Full Integrated Tapeder, Full Carbon 1.5</p>
                        <hr>
