...
$idBike = 1; // Definição fixa do ID Bikes
        ...
        <div id="carouselExampleDark" class="carousel carousel-dark slide img-fluid" data-bs-ride="carousel">
            <div class="carousel-inner">
                <div class="carousel-item active" data-bs-interval="10000">
                    <img src="https://bhbikes.b-cdn.net/cache/general/e2ee77/lr905_nbb_n1.jpg" class="d-block w-100 rounded-1" alt="...">
                </div>
                <div class="carousel-item" data-bs-interval="2000">
                    <img src="https://bhbikes.b-cdn.net/cache/general/6d4b69/lr905_nss_n1.jpg" class="d-block w-100 rounded-1" alt="...">
                </div>
                <div class="carousel-item">
                    <img src="https://bhbikes.b-cdn.net/cache/general/4845fc/lr905_nrr_n1.jpg" class="d-block w-100 rounded-1" alt="...">
                </div>
            </div>
            ...
            <div class="accordion-item">
                ...
                <div id="collapseOne" class="accordion-collapse collapse show" data-bs-parent="#accordionExample">
                    <div class="accordion-body overflow-auto">
                        ...
                        <p>There are few sensations better on a bicycle than feeling the lightness in every pedal stroke. It's an addictive feeling, one we enjoy with every acceleration. Every time we pedal standing up on the pedals. Every time we shift down a gear. Every time we change rhythm.</p>
                    </div>
                </div>
            </div>
            ...
            <div class="accordion-item">
                ...
                <div id="collapseTwo" class="accordion-collapse collapse" data-bs-parent="#accordionExample">
                    <div class="accordion-body overflow-auto">
                        ...
                        <p>Ultralight Evo Disc ACR Carbon Monocoque</p>
                        <hr>
                        <p><strong>Fork</strong></p>
                        <p>Ultralight Evo Disc, Integrated Tapered Full Carbon 1.5</p>
                        <hr>
                        <p><strong>Drivetrain</strong></p>  
                        <p><strong>Shifters</strong></p> 
                        <p>Sram Red Etap AXS</p>  
                        <p><strong>Rear Derailleur</strong></p>
                        <p>Sram Red Etap AXS</p>
                        <p><strong>Front Derailleur</strong></p>
                        <p>Sram Red Etap AXS</p>
                        <p><strong>Crankset</strong></p>
                        <p>Sram Red AXS 50/37</p>
